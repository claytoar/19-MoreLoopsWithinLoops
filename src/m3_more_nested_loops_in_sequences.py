...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 75
    answer = largest_number(([1, 5, 7], [22, 16, 75], [0, 4, -10]))
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    # Test 1:
    expected = -2.6
    answer = largest_negative_number([(30, -5, 8, -20), (100, -2.6, 88, -40, -5),
                                      (400, 500)])
    print('Expected and actual are:', expected, answer)
    ...
    # Test 3:
    expected = -0.3
    answer = largest_negative_number(([3, 7, 22, -1], [-5, -17, 2], [-0.3, 5, 10]))
    print('Expected and actual are:', expected, answer)
    ...
    for j in range(len(seq_seq)):
        ...
        for k in range(len(sublist)):
            if sublist[k] < 0:
                ...
                if abs(sublist[k]) < abs(largest_neg):
                    largest_neg = sublist[k]
    return largest_neg
